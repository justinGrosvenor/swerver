...
- [11.0-query-method.md](11.0-query-method.md) - HTTP QUERY method (RFC 10008): method classification core, body-keyed response caching, proxy retry and origin conformance.
